...
class Pokemon():
    ...
    def fight_defense(self, attack_points):
        damage = attack_points - self.defense_rating
        if damage > 0:
    ...
    def __str__(self):
        return f"Pokemon ID {self.pokemon_id} with name {self.pokemon_name} has as weapon {self.weapon_type.name} and health {self.health_points}"
